...
const DriverDashboard = () => {
  ...
  const fetchMyVehicle = async () => {
    try {
      ...
      const myAssignedVehicle = res.data.find(
        (v) => v.assignedDriver?._id === userId || v.assignedDriver === userId
      );
  ...
  return (
    <div className="main-bg min-vh-100 p-4">
      <div className="container animate__animated animate__fadeIn">
        <div
          className="d-flex justify-content-between align-items-center mb-4 p-3 glass-card shadow-sm"
          style={{ borderRadius: "15px" }}
        >
          <div className="d-flex align-items-center">
            <div
              className="bg-info rounded-circle p-2 me-3 d-flex align-items-center justify-content-center"
          ...
          <button
            ...
            className="btn glass-btn-outline btn-sm px-3"
          >
        ...
        {loading ? (
          ...
          <div className="row g-4">
            <div className="col-md-6">
              <div className="glass-card p-5 h-100 text-center text-white border-info border-opacity-25">
                ...
                <h1 className="display-3 fw-bold my-3">
                  {vehicle.plateNumber}
                </h1>
                <p className="fs-5 mb-4">{vehicle.model}</p>
                <div
                  className={`badge p-3 px-5 fs-6 rounded-pill ${
                    vehicle.status === "On Trip"
          ...
          <div className="glass-card p-5 text-center text-white mt-5 animate__animated animate__zoomIn">
            ...
            <p className="fs-5 text-white-50">
              Please contact the management to assign a vehicle to your account.
            </p>
            <button className="btn glass-btn mt-3" onClick={fetchMyVehicle}>
              Refresh Status
            </button>
          </div>
        )}
